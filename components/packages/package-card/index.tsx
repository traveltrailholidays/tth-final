...
const PackageCard: React.FC<PackageCardProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className="px-2 pt-3 flex flex-col gap-3 justify-between h-[235px]">
                <h1 className="text-lg font-semibold">{data.title}</h1>
                <div className="">
                    <span className="text-sm font-medium text-custom-clp">{data.location}</span>
                ...
                <div className="border-t flex justify-between py-3">
                    ...
                    <div>
                        {data.discount !== 0 ? (
                            ...
                            <div className="font-semibold text-custom-clp">&#8377; {data.price}</div>
                        )}
                    </div>
                </div>
            </div>
