        ...
        <Section>
            <Container className="w-full my-20 flex flex-col gap-8">
                <div className="w-full h-[300px] md:h-[60vh] overflow-hidden rounded-xl relative">
                    <Image fill src={listing.imageSrc} alt="Package Image" className="object-cover w-full" />
                ...
                <div className="w-full flex flex-col lg:flex-row gap-8">
                    <div className="w-full flex flex-col gap-16">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <span className="font-semibold text-custom-clp">{listing.location}</span>
                        </div>
                        <div className="flex flex-col gap-3">
                            <h1 className="text-3xl font-semibold">Package description</h1>
                            <p>{listing.description}</p>
                        </div>
                        <div className="flex flex-col gap-5 my-3">
                            <h1 className="text-3xl font-semibold">Itinirary</h1>
                    ...
                    <div className="lg:max-w-[350px] w-full flex flex-col gap-8">
                        <div className="rounded-xl shadow dark:shadow-white/25">
                            <div className="bg-custom-clp rounded-t-xl text-white py-3 px-5 flex items-end">
                                ...
                                <span className="font-medium text-lg">/ per person</span>
                            </div>
                            <PackageQuotaion />
                        </div>
                        <GetHelp />
